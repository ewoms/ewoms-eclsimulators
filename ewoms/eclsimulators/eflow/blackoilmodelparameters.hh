...
SET_SCALAR_PROP(EFlowModelParameters, ToleranceCnvRelaxed, 1e9);
...
SET_INT_PROP(EFlowModelParameters, MaxStrictIter, 8);
...
SET_SCALAR_PROP(EFlowModelParameters, MaxPressureChangeMsWells, 1e6);
