...
namespace Ewoms{
    ...
    void RelpermDiagnostics::satFamilyCheck_(const Ewoms::EclipseState& eclState)
    {
    ...
    void RelpermDiagnostics::swofTableCheck_(const Ewoms::SwofTable& swofTables,
                                             const int satnumIdx)
    {
    ...
    void RelpermDiagnostics::sgofTableCheck_(const Ewoms::SgofTable& sgofTables,
                                             const int satnumIdx)
    {
    ...
    void RelpermDiagnostics::slgofTableCheck_(const Ewoms::SlgofTable& slgofTables,
                                              const int satnumIdx)
    {
    ...
    void RelpermDiagnostics::swfnTableCheck_(const Ewoms::SwfnTable& swfnTables,
                                             const int satnumIdx)
    {
    ...
    void RelpermDiagnostics::sgfnTableCheck_(const Ewoms::SgfnTable& sgfnTables,
                                             const int satnumIdx)
    {
    ...
    void RelpermDiagnostics::sof3TableCheck_(const Ewoms::Sof3Table& sof3Tables,
                                             const int satnumIdx)
    {
    ...
    void RelpermDiagnostics::sof2TableCheck_(const Ewoms::Sof2Table& sof2Tables,
                                             const int satnumIdx)
    {
    ...
    void RelpermDiagnostics::sgwfnTableCheck_(const Ewoms::SgwfnTable& sgwfnTables,
                                              const int satnumIdx)
    {
    ...
    void RelpermDiagnostics::sgcwmisTableCheck_(const Ewoms::SgcwmisTable& sgcwmisTables,
                                                const int satnumIdx)
    {
    ...
    void RelpermDiagnostics::sorwmisTableCheck_(const Ewoms::SorwmisTable& sorwmisTables,
                                                const int satnumIdx)
    {
    ...
    void RelpermDiagnostics::ssfnTableCheck_(const Ewoms::SsfnTable& ssfnTables,
                                             const int satnumIdx)
    {
    ...
    void RelpermDiagnostics::miscTableCheck_(const Ewoms::MiscTable& miscTables,
    ...
    void RelpermDiagnostics::msfnTableCheck_(const Ewoms::MsfnTable& msfnTables,
                                             const int satnumIdx)
    {
