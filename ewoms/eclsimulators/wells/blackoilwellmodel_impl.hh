...
namespace Ewoms {
    ...
    void
    BlackoilWellModel<TypeTag>::
    updateWellControls(Ewoms::DeferredLogger& deferred_logger, const bool checkGroupControl, const bool checkCurrentGroupControl)
    {
                  ...
                  WellStateFullyImplicitBlackoil& state) const
    {
        ...
        for( const auto& wm : state.wellMap() ) {
            ...
            //state.currentInjectionControls()[ well_index ] = static_cast<Ewoms::Well::InjectorCMode>(well.injectionControl);
    ...
    void
    BlackoilWellModel<TypeTag>::
    checkGroupConstraints(const Group& group, const bool checkCurrentControl, Ewoms::DeferredLogger& deferred_logger) {
    ...
    void
    BlackoilWellModel<TypeTag>::
    actionOnBrokenConstraints(const Group& group, const Group::ExceedAction& exceed_action, const Group::ProductionCMode& newControl, const int reportStepIdx, Ewoms::DeferredLogger& deferred_logger) {
    ...
    void
    BlackoilWellModel<TypeTag>::
    actionOnBrokenConstraints(const Group& group, const Group::InjectionCMode& newControl, const Phase& controlPhase, const int reportStepIdx, Ewoms::DeferredLogger& deferred_logger) {
        auto& well_state = well_state_;
