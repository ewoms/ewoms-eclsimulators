...
inline std::size_t packSize(const data::GroupAndNetworkValues& data, Dune::MPIHelper::MPICommunicator comm)
{
...
inline void pack(const data::GroupAndNetworkValues& data, std::vector<char>& buffer, int& position,
                 Dune::MPIHelper::MPICommunicator comm)
{
...
// Ewoms::GroupAndNetworkValues
inline void unpack(data::GroupAndNetworkValues& data, std::vector<char>& buffer, int& position,
                   Dune::MPIHelper::MPICommunicator comm)
{
