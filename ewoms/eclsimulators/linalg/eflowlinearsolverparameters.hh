...
SET_BOOL_PROP(EFlowIstlSolverParams, UseAmg, false);
SET_BOOL_PROP(EFlowIstlSolverParams, UseCpr, false);
...
SET_STRING_PROP(EFlowIstlSolverParams, SystemStrategy, "none");
SET_BOOL_PROP(EFlowIstlSolverParams, ScaleLinearSystem, false);
SET_INT_PROP(EFlowIstlSolverParams, CprSolverVerbose, 0);
SET_BOOL_PROP(EFlowIstlSolverParams, CprUseDrs, false);
