...
//=====================================================================
    ...
    class ISTLSolverCpr : public ISTLSolver<TypeTag>
    {
    protected:
        // Types and indices from superclass.
        using SuperClass = ISTLSolver<TypeTag>;
        ...
        using CprSmootherFine           = Ewoms::ParallelOverlappingILU0<Matrix, Vector, Vector, Dune::Amg::SequentialInformation>;
        ...
        using ParallelCprSmootherFine   = Ewoms::ParallelOverlappingILU0<Matrix, Vector, Vector, POrComm >;
    ...
    public:
        ...
        explicit ISTLSolverCpr(const Simulator& simulator)
        ...
        void prepareSolver(Operator& wellOpA, Comm& comm)
        {
            ...
            const Ewoms::CPRParameter& params(this->parameters_); // strange conversion
