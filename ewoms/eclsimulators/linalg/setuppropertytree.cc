...
setupCPR(const std::string& conf, const EFlowLinearSolverParameters& p)
{
...
boost::property_tree::ptree
setupAMG([[maybe_unused]] const std::string& conf, const EFlowLinearSolverParameters& p)
{
    boost::property_tree::ptree prm;
    prm.put("tol", p.linear_solver_reduction_);
    prm.put("maxiter", p.linear_solver_maxiter_);
...
boost::property_tree::ptree
setupILU([[maybe_unused]] const std::string& conf, const EFlowLinearSolverParameters& p)
{
    boost::property_tree::ptree prm;
    prm.put("tol", p.linear_solver_reduction_);
    prm.put("maxiter", p.linear_solver_maxiter_);
