...
#ifndef EWOMS_CPRPRECONDITIONER_HH
#define EWOMS_CPRPRECONDITIONER_HH
...
template<class T>
void setILUParameters(Ewoms::ParallelOverlappingILU0Args<T>& args,
...
createAMGPreconditionerPointer( Op& opA, const double relax, const MILU_VARIANT milu, const P& comm, std::unique_ptr< AMG >& amgPtr )
{
    ...
    typedef Ewoms::Amg::Element<PressureEqnIndex, PressureVarIndex> CouplingMetric;
    ...
    public:
     ...
     protected:
        void solveElliptic(Y& x, Y& de)
        {
            ...
            if (!result.converged) {
                EWOMS_THROW(LinearSolverProblem, "CPRPreconditioner failed to solve elliptic subsystem.");
            }
        }
...
#endif // EWOMS_CPRPRECONDITIONER_HH
