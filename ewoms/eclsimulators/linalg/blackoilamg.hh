...
scaleMatrixDRS(const Operator& op, std::size_t pressureEqnIndex, const Vector& weights, const Ewoms::CPRParameter& param)
{
...
void scaleVectorDRS(Vector& vector, std::size_t pressureEqnIndex, const Ewoms::CPRParameter& param, const Vector& weights)
{
...
{
    using value = Dune::Amg::CoarsenCriterion<Dune::Amg::SymmetricCriterion<Dune::BCRSMatrix<B>, Ewoms::Amg::Element<COMPONENT_INDEX, VARIABLE_INDEX> > >;
};
...
{
    using value = Dune::Amg::CoarsenCriterion<Dune::Amg::UnSymmetricCriterion<Dune::BCRSMatrix<B>, Ewoms::Amg::Element<COMPONENT_INDEX, VARIABLE_INDEX> > >;
};
