...
NEW_TYPE_TAG(EclEFlowGasWaterProblem, INHERITS_FROM(EclEFlowProblem));

//! The indices required by the model
SET_PROP(EclEFlowGasWaterProblem, Indices)
{
private:
...
{
    using TypeTag = TTAG(EclEFlowGasWaterProblem);
...
int eflowGasWaterMain(int argc, char** argv, bool outputCout, bool outputFiles)
{
    ...
    Ewoms::EFlowMain<TTAG(EclEFlowGasWaterProblem)>
