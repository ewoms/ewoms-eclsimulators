...
NEW_TYPE_TAG(EclEFlowSolventProblem, INHERITS_FROM(EclEFlowProblem));
SET_BOOL_PROP(EclEFlowSolventProblem, EnableSolvent, true);
...
{
    typedef TTAG(EclEFlowSolventProblem) TypeTag;
...
// ----------------- Main program -----------------
int eflowSolventMain(int argc, char** argv, bool outputCout, bool outputFiles)
{
    ...
    Ewoms::EFlowMain<TTAG(EclEFlowSolventProblem)> mainfunc;
