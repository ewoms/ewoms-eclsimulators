...
{
    typedef TTAG(EclEFlowPolymerProblem) TypeTag;
...
// ----------------- Main program -----------------
int eflowPolymerMain(int argc, char** argv, bool outputCout, bool outputFiles)
{
    ...
    Ewoms::EFlowMain<TTAG(EclEFlowPolymerProblem)> mainfunc;
