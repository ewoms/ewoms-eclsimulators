...
public:
          ...
          rv_(gridView.size(/*codim=*/0))
    {
        ...
        const Ewoms::RegionMapping<> eqlmap(equilnum(eclipseState, gridView));
...
private:
    ...
    template <class RMap>
    void updateInitialSaltConcentration_(const Ewoms::EclipseState& eclState, const RMap& reg)
    {
                               ...
                               PhaseSat&         psat)
    {
             ...
             double&                      Rv) -> void
        {
            ...
            auto totfrac = 0.0;
            for (const auto& dfPair : Details::horizontalSubdivision(cell, cellZSpan_[cell], acc)) {
                const auto& depth = dfPair.first;
                const auto& frac = dfPair.second;
