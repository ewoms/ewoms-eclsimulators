...
typedef Ewoms::BlackOilFluidSystem<double> FluidSystemSimple;
...
private:
    typedef Ewoms::Tabulated1DFunction<double> RsVsDepthFunc;
...
private:
    typedef Ewoms::Tabulated1DFunction<double> PbubVsDepthFunc;
...
private:
    typedef Ewoms::Tabulated1DFunction<double> PdewVsDepthFunc;
...
private:
    typedef Ewoms::Tabulated1DFunction<double> RvVsDepthFunc;
