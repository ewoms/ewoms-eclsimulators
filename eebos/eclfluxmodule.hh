...
public:
     ...
     */
    const EvalDimVector& potentialGrad(unsigned phaseIdx EWOMS_UNUSED) const
    {
     ...
     * \param phaseIdx The index of the fluid phase
     */
    const EvalDimVector& filterVelocity(unsigned phaseIdx EWOMS_UNUSED) const
    {
...
protected:
     ...
     */
    void calculateFluxes_(const ElementContext& elemCtx EWOMS_UNUSED, unsigned scvfIdx EWOMS_UNUSED, unsigned timeIdx EWOMS_UNUSED)
    { }

    void calculateBoundaryFluxes_(const ElementContext& elemCtx EWOMS_UNUSED, unsigned scvfIdx EWOMS_UNUSED, unsigned timeIdx EWOMS_UNUSED)
    {}
