...
public:
    ...
    {
        const Ewoms::data::Solution& localCellData_;
    ...
    public:
        PackUnPackCellData(const Ewoms::data::Solution& localCellData,
                           Ewoms::data::Solution& globalCellData,
            ...
            , indexMaps_(indexMaps)
        {
            if (isIORank) {
                ...
                for (const auto& pair : localCellData_) {
                    ...
                    auto EWOMS_OPTIM_UNUSED ret = globalCellData_.insert(key, pair.second.dim,
    ...
    {
        const Ewoms::data::Wells& localWellData_;
        Ewoms::data::Wells& globalWellData_;

    public:
        PackUnPackWellData(const Ewoms::data::Wells& localWellData,
                           Ewoms::data::Wells& globalWellData,
                           bool isIORank)
    ...
    public:
        ...
        void pack(int link, MessageBufferType& buffer)
        {
            ...
            buffer.write(size);
            for (const auto& wbpPair : localWBPData_) {
                const auto& global_index = wbpPair.first;
                const auto& wbp_value = wbpPair.second;
    ...
    const Ewoms::data::Solution& globalCellData() const
