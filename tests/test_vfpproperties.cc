...
BOOST_AUTO_TEST_CASE(findInterpData)
{
    ...
    Ewoms::detail::InterpData eval0 = Ewoms::detail::findInterpData(exact, values);
    Ewoms::detail::InterpData eval1 = Ewoms::detail::findInterpData(interpolate, values);
    Ewoms::detail::InterpData eval2 = Ewoms::detail::findInterpData(extrapolate_left, values);
    Ewoms::detail::InterpData eval3 = Ewoms::detail::findInterpData(extrapolate_right, values);
    Ewoms::detail::InterpData eval4 = Ewoms::detail::findInterpData(first, values);
    Ewoms::detail::InterpData eval5 = Ewoms::detail::findInterpData(last, values);
...
struct TrivialFixture {
    typedef Ewoms::detail::VFPEvaluation VFPEvaluation;
    ...
    inline void initProperties() {
        table.reset(new Ewoms::VFPProdTable(1,
                                          1000.0,
                                          Ewoms::VFPProdTable::FLO_OIL,
                                          Ewoms::VFPProdTable::WFR_WOR,
                                          Ewoms::VFPProdTable::GFR_GOR,
                                          Ewoms::VFPProdTable::ALQ_UNDEF,
                                          flo_axis,
                                          thp_axis,
                                          wfr_axis,
                                          gfr_axis,
...
//                        double flo = Ewoms::detail::getFlo(aqua, liquid, vapour, table->getFloType());
//                        double wfr = Ewoms::detail::getWFR(aqua, liquid, vapour, table->getWFRType());
//                        double gfr = Ewoms::detail::getGFR(aqua, liquid, vapour, table->getGFRType());
...
//                        //Find values that should be in table
//                        double v = Ewoms::detail::getFlo(aqua, liquid, vapour, table->getFloType());
//                        double y = Ewoms::detail::getWFR(aqua, liquid, vapour, table->getWFRType());
//                        double z = Ewoms::detail::getGFR(aqua, liquid, vapour, table->getGFRType());
...
//                        //Calculate actual
//                        //Note order of arguments: id, aqua, liquid, vapour, thp, alq
//                        VFPEvaluation actual = Ewoms::detail::bhp(table.get(), aqua, liquid, vapour, thp, alq);
